...
#define NAME_BUTTON_EDITOR	"galileo_config_buttons"
#define NAME_BUTTON_EDITOR_RUN	"galileo_config_buttons_run"
#define NAME_PATTERNS		"galileo_pattern_stuff"
...
typedef struct
{
	...
	struct MsgPort		*notify_port;			// Galileo Notify port
	...
	long			galileo_copy;			// Copy number running
	...
	APTR			notify_req;			// Galileo Notify request
