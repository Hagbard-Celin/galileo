...
if handler='' then
	...
	/* add an icon */
	galileo addappicon handler "'Test Icon'" 1
	icon=result

	say 'Icon added.. play with it. To remove, drop Galileo on it'

	/* loop around */
	do while ((right(arg2,13) ~= 'Galileo') & (arg0 ~= 'removed'))
