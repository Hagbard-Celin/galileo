...
#ifndef _GALILEOFM_BUFFERS
#define _GALILEOFM_BUFFERS
...
#define FREEDIRF_CLEAR_HANDLER	    (1<<0)
#define FREEDIRF_FREE_LOCK	    (1<<1)
#define FREEDIRF_FREE_PATH	    (1<<2)
#define FREEDIRF_FREE_EXPANDEDPATH  (1<<3)
