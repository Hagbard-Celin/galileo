...
// Rexx Galileo command
BOOL rexx_galileo_cmd(struct RexxMsg *msg,short command,char *args)
{
	BOOL ret=0,clear=0;
	short id,val;
	char result[768];
		...
		case RXCMD_VERSION:
			{
				...
				lsprintf(result,"%ld %ld", version_num, revision_num);
			}
			break;
		...
		case RXCMD_GETDESKTOP:
			{
				...
				// Set RC explicitly
				rexx_set_var(msg,"GALILEORC",0,res,RX_LONG);
			}
			break;
			...
			switch (id)
			{
				...
				case RXCMD_PENS:
					...
					while ((val=rexx_match_keyword(&args,pens_key,0))!=-1)
					{
						...
						if (val==0)
						{
							rexx_galileo_get_pen(&args,&environment->env->icon_fpen);
							rexx_galileo_get_pen(&args,&environment->env->icon_bpen);
							rexx_galileo_get_pen(&args,&environment->env->icon_style);
							rexx_galileo_get_pen(&args,&environment->env->iconw_fpen);
							rexx_galileo_get_pen(&args,&environment->env->iconw_bpen);
							rexx_galileo_get_pen(&args,&environment->env->iconw_style);
						}
						...
						if (val==1)
						{
							rexx_galileo_get_pen(&args,&environment->env->list_format.files_unsel[0]);
							rexx_galileo_get_pen(&args,&environment->env->list_format.files_unsel[1]);
						}
						else
						if (val==2)
						{
							rexx_galileo_get_pen(&args,&environment->env->list_format.dirs_unsel[0]);
							rexx_galileo_get_pen(&args,&environment->env->list_format.dirs_unsel[1]);
						}
						else
						if (val==3)
						{
							rexx_galileo_get_pen(&args,&environment->env->list_format.files_sel[0]);
							rexx_galileo_get_pen(&args,&environment->env->list_format.files_sel[1]);
						}
						else
						if (val==4)
						{
							rexx_galileo_get_pen(&args,&environment->env->list_format.dirs_sel[0]);
							rexx_galileo_get_pen(&args,&environment->env->list_format.dirs_sel[1]);
						}
						...
						if (val==5)
						{
							rexx_galileo_get_pen(&args,&environment->env->devices_col[0]);
							rexx_galileo_get_pen(&args,&environment->env->devices_col[1]);
						}
						else
						if (val==6)
						{
							rexx_galileo_get_pen(&args,&environment->env->volumes_col[0]);
							rexx_galileo_get_pen(&args,&environment->env->volumes_col[1]);
						}
						...
						if (val==7)
						{
							rexx_galileo_get_pen(&args,&environment->env->source_col[0]);
							rexx_galileo_get_pen(&args,&environment->env->source_col[1]);
						}
						else
						if (val==8)
						{
							rexx_galileo_get_pen(&args,&environment->env->dest_col[0]);
							rexx_galileo_get_pen(&args,&environment->env->dest_col[1]);
						}
						...
						if (val==9)
						{
							rexx_galileo_get_pen(&args,&environment->env->gauge_col[0]);
							rexx_galileo_get_pen(&args,&environment->env->gauge_col[1]);
						}
					...
					while ((val=rexx_match_keyword(&args,pens_key,0))!=-1)
					{
						...
						if (val==0)
							lsprintf(buf,"%ld %ld %ld %ld %ld %ld ",
								rexx_galileo_map_pen(environment->env->icon_fpen),
								rexx_galileo_map_pen(environment->env->icon_bpen),
								rexx_galileo_map_pen(environment->env->icon_style),
								rexx_galileo_map_pen(environment->env->iconw_fpen),
								rexx_galileo_map_pen(environment->env->iconw_bpen),
								rexx_galileo_map_pen(environment->env->iconw_style));

						// Files/dirs
						else
						if (val==1)
							lsprintf(buf,"%ld %ld ",
								rexx_galileo_map_pen(environment->env->list_format.files_unsel[0]),
								rexx_galileo_map_pen(environment->env->list_format.files_unsel[1]));
						else
						if (val==2)
							lsprintf(buf,"%ld %ld ",
								rexx_galileo_map_pen(environment->env->list_format.dirs_unsel[0]),
								rexx_galileo_map_pen(environment->env->list_format.dirs_unsel[1]));
						else
						if (val==3)
							lsprintf(buf,"%ld %ld ",
								rexx_galileo_map_pen(environment->env->list_format.files_sel[0]),
								rexx_galileo_map_pen(environment->env->list_format.files_sel[1]));
						else
						if (val==4)
							lsprintf(buf,"%ld %ld ",
								rexx_galileo_map_pen(environment->env->list_format.dirs_sel[0]),
								rexx_galileo_map_pen(environment->env->list_format.dirs_sel[1]));

						// Devices/assigns
						else
						if (val==5)
							lsprintf(buf,"%ld %ld ",
								rexx_galileo_map_pen(environment->env->devices_col[0]),
								rexx_galileo_map_pen(environment->env->devices_col[1]));
						else
						if (val==6)
							lsprintf(buf,"%ld %ld ",
								rexx_galileo_map_pen(environment->env->volumes_col[0]),
								rexx_galileo_map_pen(environment->env->volumes_col[1]));

						// Source/dest
						else
						if (val==7)
							lsprintf(buf,"%ld %ld ",
								rexx_galileo_map_pen(environment->env->source_col[0]),
								rexx_galileo_map_pen(environment->env->source_col[1]));
						else
						if (val==8)
							lsprintf(buf,"%ld %ld ",
								rexx_galileo_map_pen(environment->env->dest_col[0]),
								rexx_galileo_map_pen(environment->env->dest_col[1]));

						// Gauge
						else
						if (val==9)
							lsprintf(buf,"%ld %ld ",
								rexx_galileo_map_pen(environment->env->gauge_col[0]),
								rexx_galileo_map_pen(environment->env->gauge_col[1]));
...
// Get a pen colour
void rexx_galileo_get_pen(char **args,UBYTE *ptr)
{
	// Get pen number
...
// Map pen colour back
short rexx_galileo_map_pen(short pen)
{
