...
char *version="$VER: print.gfmmodule 0.1 "__AMIGADATE__" ";
	...
	register __d1 ULONG mod_data)
{
	...
	GetVar("Galileo/Print",(char *)&data->print_quality,DATA_SIZE,GVF_BINARY_VAR|GVF_DONT_NULL_TERM);
	...
	if (break_flag==2)
	{
		...
		SetVar("Galileo/Print",(char *)&data->print_quality,DATA_SIZE,GVF_GLOBAL_ONLY);
	}
