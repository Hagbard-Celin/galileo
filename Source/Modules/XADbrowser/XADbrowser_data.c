...
{
		 1, "XADExtract", MSG_XADEXTRACT_DESC, FUNCF_SYNC|FUNCF_WANT_SOURCE|FUNCF_WANT_DEST|FUNCF_NEED_FILES|FUNCF_WANT_ENTRIES|FUNCF_SINGLE_DEST|FUNCF_SINGLE_SOURCE, XADEXTRACT_ARGS
};
