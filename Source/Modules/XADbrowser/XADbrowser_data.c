...
ModuleInfo module_info =
{
		...
		{0, "XADOpen", MSG_XADOPEN_DESC, FUNCF_NEED_SOURCE|FUNCF_NEED_FILES|FUNCF_SINGLE_SOURCE|FUNCF_WANT_DEST, XADOPEN_ARGS}
};


ModuleFunction more_functions[] =
{
		 1, "XADExtract", MSG_XADEXTRACT_DESC, FUNCF_SYNC|FUNCF_NEED_SOURCE|FUNCF_NEED_DEST|FUNCF_NEED_FILES|FUNCF_SINGLE_DEST|FUNCF_SINGLE_SOURCE, 0
};
