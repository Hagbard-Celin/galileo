...
char *rexx_getstring        ( const char *galileo, APTR handle, char *text, BOOL secure, int length, char *deflt, char *buttons );
void  rexx_lst_add          ( const char *galileo, APTR handle, char *name, unsigned int size, int type, ULONG seconds, LONG prot, char *comment );
...
void  rexx_lst_label        ( const char *galileo, APTR handle, char *pref, char *label, char *suff );
...
void  rexx_lst_title        ( const char *galileo, APTR handle, char *host );
char *rexx_lst_title_swap   ( const char *galileo, APTR handle, char *host );
...
void  rexx_prog_info2       ( const char *galileo, APTR handle, int type, char *info2 );
void  rexx_prog_info3       ( const char *galileo, APTR handle, int type, char *info3 );
APTR  rexx_prog_init        ( const char *galileo, APTR handle, int type, char *title, char *info, char *name, int file, int bar );
APTR  rexx_prog_init3       ( const char *galileo, APTR handle, int type, char *title, char *info, char *info2, char *info3, char *name, int file, int bar );
