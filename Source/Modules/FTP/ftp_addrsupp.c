...
char *CONFIGFILE	="PROGDIR:System/ftp.config";
char *FTP_OPTIONS_NAME	="PROGDIR:System/ftp_options";
char *FTP_ADDR_NAME	="PROGDIR:System/ftp_sites";
...
static BOOL do_save_options_iff(struct window_params *wp,char *filename,int type,LONG *diskerr)
{
	...
	// Open IFF file
	if (iff=IFFOpen(filename,IFF_WRITE|IFF_SAFE,ID_GILO))
	{
