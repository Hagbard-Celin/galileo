...
typedef struct galileogadgetbanks {
	struct newgalileofmfunction gadgets[GADCOUNT];
...
#ifndef GALILEOFM_CONFIGFLAGS
#define GALILEOFM_CONFIGFLAGS

/* ErrorFlags */

#define ERROR_ENABLE_DOS  1
#define ERROR_ENABLE_GALILEO_FM 2
